...
pub async fn gravar_nova_tarefa(
    ...
    let dados_tarefa = query!(
        "INSERT INTO kanban.tarefas (titulo_tarefa, descricao_tarefa, pk_coluna, id_usuario, prioridade)
        VALUES ($1, $2, $3, $4, $5) 
...
pub async fn editar_tarefa(
    ...
    query!(
        "UPDATE kanban.tarefas SET titulo_tarefa=$2, descricao_tarefa=$3, pk_coluna=$4, prioridade=$5 WHERE id_tarefa=$1",
        id_tarefa,
        titulo,
        descricao,
        id_coluna,
